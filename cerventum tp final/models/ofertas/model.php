...
require("models/abstractModel.php");
 ...
 class model extends abstractModel{
	...
	static function listarOfertas($id_cerveceria,$desde,$hasta){
		$conn = connect();
		$sql = "select o.id,o.titulo,o.fecha_desde,o.fecha_hasta,o.descripcion,desc_tipo,img_path from ofertas o inner join tipo_oferta on tipo_oferta.id_tipo = o.tipo_id			
