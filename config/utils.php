...
<p>
Para finalizar tu registracion sigue el siguiente vinculo. <a style='background-color:#f64347;color:#ffffff;font-family:Helvetica,Arial,sans-serif;font-size:16px;line-height:22px;border-radius:32px;text-align:center;text-decoration:none;display:block;margin:0px 0px;padding:15px 20px;width:320px;font-weight:bold' href=" . ROOT_PATH ."/registra/validar/".$hash. ">finalizar registro</a>
</p>
</body>
</html>";
